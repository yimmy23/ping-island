...
enum AppSettings {
    ...
    static let defaultSettingsWindowSize = CGSize(width: 648, height: 522)
    static let minimumSettingsWindowSize = CGSize(width: 648, height: 522)
    static let maximumSettingsWindowSize = CGSize(width: 648, height: 522)
