...
<p align="center">
  <img src="docs/images/ping-island-hermes-poster.png" width="960" alt="Ping Island Hermes Agent 能力海报">
</p>
...
README 里的 Hermes 能力海报由 `./scripts/render-hermes-poster.sh` 生成，对应产物在 `docs/images/ping-island-hermes-poster.png`。
