...
README 里的 `0.3.0` Codex 海报由 `./scripts/render-release-highlights-posters.sh` 生成，对应产物在 `docs/images/ping-island-0.3.0-codex-cn.png`。
README 里的 `0.3.0` Codex / Qoder 海报由 `./scripts/render-release-highlights-posters.sh` 生成，对应产物在 `docs/images/ping-island-0.3.0-codex-qoder-cn.png`。
README 里的 `0.3.0` 更新日志海报由 `./scripts/render-release-highlights-posters.sh` 生成，对应产物在 `docs/images/ping-island-0.3.0-update-log-cn.png`。
