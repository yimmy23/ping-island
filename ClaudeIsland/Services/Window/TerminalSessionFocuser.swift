...
actor TerminalSessionFocuser {
    ...
    private let logger = Logger(subsystem: "com.wudanwu.island", category: "TerminalFocus")

    private init() {}

    func focusSession(terminalPid: Int, tty: String?, candidateProcessIDs: [Int] = []) async -> Bool {
